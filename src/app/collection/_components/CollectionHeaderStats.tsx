  ...
  return (
    <div className="flex gap-4">
      <div className="rounded-xl border border-slate-700 bg-slate-800 p-4 min-w-[140px]">
        ...
        <div className="text-2xl text-center font-bold text-white">{stats.totalCards}</div>
      </div>
      ...
      <div className="rounded-xl border border-slate-700 bg-slate-800 p-4 min-w-[140px]">
        ...
        <div className="text-2xl text-center font-bold text-white">{stats.rareCards}</div>
      </div>
    </div>
  );
}
