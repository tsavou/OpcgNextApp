...
export function CollectionInfoBadge({
  ...
  return (
    <div className="group/badge relative z-30 inline-block">
      ...
      <div className="pointer-events-none absolute top-full left-0 mt-2 w-max max-w-[200px] min-w-[120px] origin-top-left scale-95 opacity-0 transition-all duration-200 group-hover/badge:scale-100 group-hover/badge:opacity-100">
        <div className="rounded-lg border border-slate-700 bg-slate-900/95 p-3 text-xs shadow-xl backdrop-blur-md">
          <div className="mb-2 flex items-center justify-between gap-3 border-b border-slate-700/50 pb-2">
          ...
          {collectionDetails.is_graded && (
            <div className="mb-2 flex items-center gap-1.5 text-yellow-400">
              ...
              <span className="font-semibold">
                {collectionDetails.grading_service}{" "}
                {collectionDetails.grade_note}
              </span>
            </div>
          )}
            ...
            <div className="flex items-center gap-1.5 text-emerald-400">
              ...
              <span>
                ...
                <span className="font-bold">
                  {collectionDetails.purchase_price} €
                </span>
              </span>
            </div>
          )}
          ...
          {!collectionDetails.is_graded &&
            (!collectionDetails.purchase_price ||
              collectionDetails.purchase_price === 0) && (
