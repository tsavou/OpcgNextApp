  ...
  return (
    <div className="rounded-2xl border border-slate-700 bg-slate-800/50 p-6 shadow-lg backdrop-blur-sm">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold text-white">{t("preferencesTitle")}</h2>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between rounded-lg border border-slate-700 bg-slate-900/50 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-400">{t("notifications")}</p>
              <p className="text-xs text-slate-500">{t("notificationsDescription")}</p>
            </div>
          </div>
