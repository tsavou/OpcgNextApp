...
export function UserMenu({
  ...
  if (variant === "mobile") {
    return (
      <>
        ...
        <button
          onClick={onLogout}
          className="group flex w-full cursor-pointer items-center gap-2 rounded-lg px-4 py-2 text-base font-medium text-red-400 transition-all hover:bg-red-900/30 hover:text-red-300 hover:shadow-lg hover:shadow-red-500/20"
        >
  ...
  return (
    <>
      ...
      <button
        onClick={onLogout}
        className="group flex w-full cursor-pointer items-center gap-2 px-4 py-2 text-sm font-medium text-red-400 transition-all hover:bg-red-900/30 hover:text-red-300 hover:shadow-lg hover:shadow-red-500/20"
      >
