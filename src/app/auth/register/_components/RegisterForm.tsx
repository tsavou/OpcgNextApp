  ...
  return (
    <div className="w-full max-w-md space-y-8 text-center lg:text-left">
      <div className="space-y-4">
        ...
        <p className="text-lg text-slate-400">{t("registerWelcome")}</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="rounded-xl border border-slate-700 bg-slate-800/50 px-4 py-3 text-white backdrop-blur-sm transition-all placeholder:text-slate-500 focus:border-sky-500 focus:bg-slate-800 focus:ring-2 focus:ring-sky-500/50 focus:outline-none"
              {...form.register("email")}
            />
