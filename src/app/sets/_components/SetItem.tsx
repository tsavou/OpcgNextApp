...
export function SetItem({ set }: SetItemProps) {
  return (
    <Link
      ...
      className={`cursor-pointer group bg-gradient-to-br ${getSetColor(set.set_id)} relative aspect-[8/3] overflow-hidden rounded-xl transition-all duration-300 hover:scale-105 hover:hover:shadow-[0_0_20px_rgba(255,255,255,0.5)]`}
    >
      <Image
